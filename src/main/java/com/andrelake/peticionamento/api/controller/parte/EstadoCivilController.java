...
public class EstadoCivilController {
	...
	@PostMapping
	public ResponseEntity<EstadoCivil> insert(@RequestBody @Valid EstadoCivil estadoCivil) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<EstadoCivil> update(@PathVariable Long id, @RequestBody @Valid EstadoCivil estadoCivil) {
